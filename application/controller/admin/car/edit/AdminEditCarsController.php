                                                    ...
                                                    if(array_key_exists('nombre_de_place',$_POST) && isset($_POST['nombre_de_place']) && ctype_digit($_POST['nombre_de_place']) && strlen($_POST['nombre_de_place']) === 1){  
                                                        if(array_key_exists('id_category',$_POST) && isset($_POST['id_category']) && ctype_digit($_POST['id_category']) && strlen($_POST['id_category']) === 1){ 
                                                            if(array_key_exists('image_url',$_FILES) && isset($_FILES['image_url']) && !empty($_FILES['image_url'])){
                                                                ...
                                                                //pre_var_dump($_FILES,$_POST, true);
                                                                if (empty($good_img)) {
                                                                    redirect("index.php?action=admin&action2=car&action3=editForm");
                                                                }

                                                                

                                                                editCars((string)$_POST['marque'], (string)$_POST['modele'], (int)$_POST['annee'], (int)$_POST['conso'], (string)$_POST['color'], (int)$_POST['prix_trois_jours'], (int)$_POST['puissance'], $_POST['moteur'], (string)$_POST['carburant'], (int)$_POST['cent'], (int)$_POST['nombre_de_place'], (int)$_POST['id_category'], (int)$_POST['id'], (string) $good_img);
